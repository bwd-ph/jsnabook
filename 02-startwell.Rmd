...
Figure \@ref(fig:NCMPchart) shows the results of the latest National Child Measurement Programme (NCMP) survey in 2016/17 _[@PHE_NCMP]_.  Most of Blackburn with Darwen’s results are fairly close to average.

```{r NCMPchart, fig.cap='National Child Measurement Programme 2016-17', echo = FALSE, out.width = '60%', fig.align='center'}
knitr::include_graphics("Assets/p20fig41.png")
```

#### Underweight children
One statistic which is significantly higher than average is the proportion of Year 6 children who are underweight. In both Reception (2.5%) and Year 6 (3.0%), Blackburn with Darwen has the third highest proportion of underweight children. It should be noted that nationally, pupils of Asian heritage are much more likely than average to be underweight.

#### Severe obesity 
For the first time, the 2016/17 survey tells us how many pupils are _severely_ obese, putting them at risk of serious acute and chronic health problems. Blackburn with Darwen had 58 Reception pupils in this category (2.59%), and 99 Year 6 pupils (4.8%). These proportions are slightly higher than average, but not significantly so.

#### Inequalities
Figure \@ref(fig:NCMPmap) shows that there are marked spatial inequalities in ‘excess weight’ (i.e. ‘overweight’ upwards) across Blackburn with Darwen. Public Health England has also looked at obesity alone, for five years combined (2012/13-2016/17), to see how it varies with deprivation. They found a strong relationship within most local authorities, including Blackburn with Darwen, with obesity tending to be highest in the most deprived quintile and lowest in the least deprived _[@PHE_NCMP]_.

```{r NCMPmap, fig.cap='Prevalence of Excess Weight, 2014/15 - 2016/17', echo = FALSE, out.width = '70%', fig.align='center'}
...
According to police figures, 48 children aged 0-15 were killed or seriously injured (KSI) on Blackburn with Darwen’s roads in the three years from 2014 to 2016 (see Figure \@ref(fig:KSImap) for locations). This total included the first child fatality on Blackburn with Darwen’s roads since 2006. The borough now has the highest crude child KSI rate of any upper-tier authority in England _[@PHE_childhealth]_. This is despite the fact that in 2016, many other police forces (_not_ including Lancashire) introduced new reporting systems which more readily classify injuries as ‘serious’ _[@DfT_roadcas]_. 

(ref:KSImapcap) Children (0-15) Killed or Seriously Injured (KSI)<br/>in Blackburn with Darwen 2014-16<br/><em>(showing ward boundaries)</em>

```{r KSImap, fig.cap='(ref:KSImapcap)', echo=FALSE,out.width='60%', fig.align='center'}
knitr::include_graphics("Assets/p21fig44.png")
```

Figure \@ref(fig:KSImosaic) looks at all young people killed or seriously injured up to the age of 25, over a five-year period (2012-16). The casualties are broken down by type of road user (columns) as well as by age (light to dark shading). There were two fatalities: a child pedestrian, and a motor-cyclist aged 21-25. All the other casualties were serious injuries. Approximately half were pedestrians, of whom almost half were aged under 11 _[@DfT_Stats19]_. 

(ref:KSImosaiccap) Breakdown of 153 KSI casualties aged 0-25<br/>by age & road-user type (BwD, 2012-16)
...
The borough’s rate of pedestrian KSI casualties among children and young people is well above the national average (Figure \@ref(fig:pedKSIchart)), particularly at the youngest ages _[@DfT_Stats19]_. For the 0-25 age-group as a whole, it is second only to the (unusually small) City of London _[@Pedsafe]_.

(ref:pedKSIcap) Pedestrian KSI rate per 100,000 children/young people<br/>(BwD v. England, 2012-16)</br><em>showing 95% confidence intervals</em>
...
If we broaden our scope to include all recorded child casualties on the road, whether serious or not, Blackburn with Darwen still compares badly. When we add up the total number of casualties aged 0-15 during the years 2012 to 2016, and express it as a crude rate (relative to the 0-15 year-old resident population), the borough ranks 4th highest out of 152 upper-tier authorities in England _[@DfT_casualties]_. 
